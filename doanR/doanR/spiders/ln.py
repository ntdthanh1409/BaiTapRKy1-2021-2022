...
class LnSpider(scrapy.Spider):      #spider để crawl thông tin chi tiết của từng LN/WN
    ...
    # all_urls = all_urls[0:100]
        
    def parse(self, response):  # truy cập vào từng bộ với thời gian nghỉ là 2 giây để chống lỗi truy cập quá nhiều
    ...
    def parse_ln(self, response): # lấy thông tin chi tiết và delay 1s
